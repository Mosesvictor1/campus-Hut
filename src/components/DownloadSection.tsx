  ...
  return (
    <section className="py-16 bg-gradient-to-r from-campusGreen-600 to-campusGreen-700 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl mb-8 text-campusGreen-100" data-aos="fade-up">
          Join other smart students already using CampusHut
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          ...
          <a
            href="https://apps.apple.com/ng/app/campushut-student-app/id6755047066"
            target="_blank"
            rel="noopener noreferrer"
            data-aos="zoom-out-right"
          >
